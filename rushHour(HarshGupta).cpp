// Versión modificada por Gabriel Balassa de:
// https://github.com/hgupta20/RushHour/blob/master/rushHour.cpp (por Harsh Devprakash Gupta)
...
static char vehicle; // global variables for Vehicle
static char direction; // global variables for Direction
static int numOfSquares; // global variables for Number Of Squares
...
static int moveRightorDown(char &n1, char &n2, char &n3, char &n4, char &n5, char &n6, int carSize, char distance)
{
...
static int moveLeftorUp(char &n1, char &n2, char &n3, char &n4, char &n5, char &n6, int carSize, char distance)
{
    char tempVar;
    if (carSize == 2 ){ // Comparing with the Car Size- 2
    	if (n6 == vehicle && n4 == '.'){
...
static void handlePieces(char &n1, char &n2, char &n3, char &n4, char &n5, char &n6, int carSize, char distance, char command, int roworcol)
{
	int flag =0;
